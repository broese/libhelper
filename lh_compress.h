...
#define zlib_encode_to(ibuf,ilen,obuf,olen) lh_zlib_encode(ibuf,ilen,obuf,olen)
#define zlib_decode_to(ibuf,ilen,obuf,olen) lh_zlib_decode(ibuf,ilen,obuf,olen)
...
#define gzip_encode_to(ibuf,ilen,obuf,olen) lh_gzip_encode(ibuf,ilen,obuf,olen)
#define gzip_decode_to(ibuf,ilen,obuf,olen) lh_gzip_decode(ibuf,ilen,obuf,olen)
